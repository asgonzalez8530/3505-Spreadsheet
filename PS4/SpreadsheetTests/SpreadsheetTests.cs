...
namespace SpreadsheetModelTests
{
    ...
    public class SpreadsheetTests
    {
        ...
        public void GetCellContentsString()
        {
            ...
            string actualContents = (string)sheet.GetCellContents("x1");
            Assert.AreEqual(expectedContents, actualContents);
            string actualValue = (string)sheet.GetCellContents("x1");
            Assert.AreEqual(expectedContents, actualValue);
            ...
            Assert.AreEqual(expectedContents, actualContents);
            actualValue = (string)sheet.GetCellContents("x1");
            Assert.AreEqual(expectedContents, actualValue);
        }
        ...
        public void GetCellContentsDouble()
        {
            ...
            Assert.AreEqual(expectedContents, actualContents);
            actualValue = (double)sheet.GetCellValue("x2");
            Assert.AreEqual(expectedContents, actualContents);
