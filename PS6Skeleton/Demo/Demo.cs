...
namespace SS
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            spreadsheetPanel1.Focus(3, 2);
            spreadsheetPanel1.Focus(7, 3);
            spreadsheetPanel1.Focus(5, 3);

            spreadsheetPanel1.Focus(3, 3);
            spreadsheetPanel1.Focus(0, 9);
            //spreadsheetPanel1.Focus(7, 3);
            //spreadsheetPanel1.Focus(7, 3);
            spreadsheetPanel1.Unfocus(5, 3);
