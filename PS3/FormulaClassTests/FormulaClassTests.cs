...
namespace FormulaClassTests
{
    ...
    public class FormulaClassTests
    {
        ...
        //        try
        //        {
        //            Assert.AreEqual(values[i] * 2, formula.Evaluate(variables[i], x => values[i] + values[i]));
        ...
        //    Assert.AreEqual(expected, formula.Evaluate(expression, x => 0));
        ...
        //    Assert.AreNotEqual(formula.Evaluate("4+3*3", x => 0), formula.Evaluate("4*3+3", x => 0));
        ...
        //        Assert.AreEqual(expected, formula.Evaluate(expression, x => n));
        //    }
        ...
        //    {
        //        int n = (int)Math.Pow(2, i);
        //        Assert.AreEqual(n, formula.Evaluate(expression, x => n));
        //    }
        //}
        ...
        //    {
        //        Assert.AreEqual(formula.Evaluate(expression, x => i), formula.Evaluate(equivalent, x => i));
        //    }
        ...
        //        {
        //            int n = (int)Math.Pow(2, i);
        //            formula.Evaluate(expression, x => n);
